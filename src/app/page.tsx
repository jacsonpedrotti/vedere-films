...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed] flex flex-col overflow-x-hidden">
      ...
      {/* SOBRE RESTAURADO */}
      <section id="sobre" className="max-w-7xl mx-auto py-32 px-4 my-20 mt-32">
        <div className="grid md:grid-cols-2 gap-12 md:gap-24 lg:gap-[120px] items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="relative h-[600px] md:h-[520px] rounded-lg overflow-hidden"
          >
            <Image
              src="/image-sobre.jpg"
        ...
        >
          ...
          >
            ...
            <a href="/servicos/peliculas-residenciais" className="bg-[#181818] rounded-lg p-10 shadow-lg hover:shadow-xl transition-shadow" style={{ minWidth: '25%', padding: '0 1.5rem', display: 'block' }}>
              <div className="relative h-72 mb-8 rounded-lg overflow-hidden">
                <video
                  src="/videos/peliculas-residenciais.mp4"
                  muted
                  loop
                  playsInline
                  controls={false}
